...
#| include: false
 #colour palettes for predictions
  ...
  D50.pal <- colorNumeric(c("#e9c602", "#0E7329"), domain = TN_river$D50, na.color = "transparent")  
...
TN_map <- leaflet(width = 1900, height = 2100) |> 
      ...
      ### D50
      addPolylines(data = TN_river, color = ~D50.pal(TN_river$D50), weight = 3/TN_river$ORD_CLAS, opacity = 1, options = pathOptions(pane = "reaches"), group = "D50", popup = ~label_text) |>
      addLegend(pal = D50.pal, values = TN_river$D50,
